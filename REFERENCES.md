...
A consolidated list of all references used throughout *Quantum Computing: Mechanisms Unveiled*, organized by chapter.

---

## General Resources

These resources span multiple chapters and provide comprehensive coverage:

- **Qiskit Textbook** — IBM's free interactive quantum computing textbook: [IBM Quantum Learning](https://learning.quantum.ibm.com/)
- **Preskill's Caltech Lecture Notes (Ph219)** — Graduate-level quantum information course: [Caltech Ph219](http://theory.caltech.edu/~preskill/ph219/ph219_2023-24/)
- **Scott Aaronson, "Quantum Computing Since Democritus"** — Lecture notes bridging CS theory and quantum mechanics: [Lecture Notes](https://www.scottaaronson.com/democritus/)

---

## Chapter 1: What Is a Qubit?

- Preskill's Caltech Lecture Notes — Mathematical foundations of quantum states
...
- [Quantum Computing Report](https://quantumcomputingreport.com/) — Comprehensive industry tracker
- Qiskit Textbook — IBM's open quantum computing curriculum

---

## Downloaded PDFs (in `references/` folder)

| File | Paper |
|------|-------|
| `preskill-nisq-2018.pdf` | Preskill, "Quantum Computing in the NISQ Era and Beyond" |
| `google-supremacy-2019.pdf` | Arute et al., "Quantum supremacy using a programmable superconducting processor" |
| `google-willow-2024.pdf` | Google Quantum AI, below-threshold error correction |
| `shor-1994.pdf` | Shor, "Algorithms for Quantum Computation" |
| `grover-1996.pdf` | Grover, "A Fast Quantum Mechanical Algorithm for Database Search" |
| `fowler-surface-codes-2012.pdf` | Fowler et al., "Surface codes" |
| `terhal-qec-review-2015.pdf` | Terhal, "Quantum error correction for quantum memories" |
